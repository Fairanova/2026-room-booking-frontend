    ...
    content.innerHTML = `
        <div class="container">
            <div class="card" style="max-width: 400px; margin: 2rem auto;">
                ...
                <p class="text-center text-muted">Login page will be implemented in Phase 2</p>
    ...
    content.innerHTML = `
        <div class="container">
            <div class="card" style="max-width: 400px; margin: 2rem auto;">
                ...
                <p class="text-center text-muted">Register page will be implemented in Phase 2</p>
                <div class="text-center mt-3">
                    <a href="#/" class="btn btn-secondary">Back to Home</a>
                </div>
            </div>
